 ...
 */
public class CarbonDelegate extends UiManagingDelegate {
    public static final String SKU_ID = "100_dollars";
    ...
    public CarbonDelegate(BillingProvider billingProvider) {
