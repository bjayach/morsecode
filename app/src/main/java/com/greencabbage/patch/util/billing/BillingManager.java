...
public class BillingManager implements PurchasesUpdatedListener {
     ...
     */
    private static final String BASE_64_ENCODED_PUBLIC_KEY = "";
    /**
    ...
    public void querySkuDetailsAsync(@SkuType final String itemType, final List<String> skuList,
        ...
        Log.d(TAG, "****Starting querySkuDetailsAsync.");
        Runnable queryRequest = new Runnable() {
            @Override
            public void run() {
                // Query the purchase async
                Log.d(TAG, "****Running querySkuDetailsAsync-1:");
                ...
                mBillingClient.querySkuDetailsAsync(params.build(),
                        new SkuDetailsResponseListener() {
                            ...
                            public void onSkuDetailsResponse(int responseCode,
                                ...
                                Log.d(TAG, "****Running querySkuDetailsAsync-2 skuDetailsList size:"+skuDetailsList.size());
                                listener.onSkuDetailsResponse(responseCode, skuDetailsList);
                            }
                        });
            }
        };
        Log.d(TAG, "****Running querySkuDetailsAsync-3:");
    ...
    private void executeServiceRequest(Runnable runnable) {
        Log.d(TAG, "****Running executeServiceRequest-1:");
        if (mIsServiceConnected) {
            Log.d(TAG, "****Running executeServiceRequest-2:");
            runnable.run();
        } else {
            // If billing service was disconnected, we try to reconnect 1 time.
            // (feel free to introduce your retry policy here).
            Log.d(TAG, "****Running executeServiceRequest-3:");
