 ...
 */
public class PlatinumDelegate extends UiManagingDelegate {
    public static final String SKU_ID = "12_dollars";
    ...
    public PlatinumDelegate(BillingProvider billingProvider) {
