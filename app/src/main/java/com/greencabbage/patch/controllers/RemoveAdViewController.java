package com.greencabbage.patch.controllers;
...
import com.greencabbage.patch.activity.RemoveAd;
 ...
 */
public class RemoveAdViewController {
    private static final String TAG = "RemoveAdViewController";
    ...
    public RemoveAdViewController(RemoveAd activity) {
